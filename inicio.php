...
<body>
	...
	<script src="restaurant_main/js/jquery-3.3.1.slim.min.js"></script>
	<script src="restaurant_main/js/popper.min.js"></script>
	<script src="restaurant_main/js/bootstrap.min.js"></script>
</body>
</html>