...
if (!empty($id)) {
    $sql_user = "SELECT * FROM pedido pe
        ...
        INNER JOIN usuario usu ON usu.codUsu = pe.codUsu
        WHERE usu.priUsu=2 and pe.codPedi = '" . $id ."'";
                            ...
                            <div class="col-12 col-md-5 col-lg-4">
                                <div class="full-box div-bordered">
                                    ...
                                    <a class="list-group-item d-flex justify-content-between align-items-center text-uppercase poppins-regular font-weight-bold">
                                            <strong>Motoquero a Entregar: </strong>
                                            <span><?php echo $nom_usu.' '. $app_usu;?></span>
                                        </a>
                                        <a class="list-group-item d-flex justify-content-between align-items-center text-uppercase poppins-regular font-weight-bold">
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                   <h1 class="modal-title text-center text-danger">Ubicacion Exacta<h1>
