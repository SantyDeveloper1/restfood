<?php
   ...
   // $hoy = date('Y-m-d');
    ...
    if($action == 'ajax'){
        ...
        $id = $_SESSION['codUsu'];
        $sql ="SELECT *FROM usuario WHERE priUsu=1 AND codUsu<>'".$id."'";
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <div class="btn-group btn-group-xs">
                                    ...
                                    data-toggle="modal" data-target="#modal-UpdateUsuario" 
